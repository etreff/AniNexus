...
public static class CancellationTokenSourceExtensions
{
    ...
    public static bool IsNotCancelledAfter(this CancellationTokenSource cancellationTokenSource, TimeSpan duration)
        => (cancellationTokenSource ?? throw new ArgumentNullException(nameof(cancellationTokenSource))).Token.IsNotCancelledBefore(duration);
    ...
    {
        return cancellationTokenSource.Token.IsNotCancelledBeforeAsync(duration);
    }
}
