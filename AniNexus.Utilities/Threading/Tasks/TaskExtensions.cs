...
public static class TaskExtensions
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The task that completed first.</returns>
    public static Task WhenAll<TResult>(this IEnumerable<Task<TResult>>? tasks, CancellationToken cancellationToken)
    {
        return tasks is null
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The task that completed first.</returns>
    public static Task<Task> WhenAny(this IEnumerable<Task>? tasks, CancellationToken cancellationToken)
    {
        return tasks is null
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The task that completed first.</returns>
    public static Task<Task<TResult>> WhenAny<TResult>(this IEnumerable<Task<TResult>>? tasks, CancellationToken cancellationToken)
    {
        return tasks is null
    ...
    public static Task<TResult> WhenAny<TResult>(this IEnumerable<Task<TResult>>? tasks, Predicate<TResult> predicate, CancellationToken cancellationToken)
    {
        if (tasks is null)
        {
