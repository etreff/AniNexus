...
/// </summary>
internal sealed class HasSoftDeleteConvention : IPreConfigureEntityConvention, IPostConfigureEntityConvention
{
    ...
    {
        var method = _softDeleteFilterMethod ??=
            typeof(HasSoftDeleteConvention)
