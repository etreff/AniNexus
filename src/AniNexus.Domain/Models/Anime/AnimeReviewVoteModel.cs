...
/// </summary>
public class AnimeReviewVoteModel : IEntityTypeConfiguration<AnimeReviewVoteModel>
{
    /// <summary>
    /// The Id of the vote.
    /// </summary>
    ...
    /// </summary>
    public AnimeReviewModel Review { get; set; } = default!;
    #endregion

    public void Configure(EntityTypeBuilder<AnimeReviewVoteModel> builder)
    {
        builder.ToTable("AnimeReviewVote");
