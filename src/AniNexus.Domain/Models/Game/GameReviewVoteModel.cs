...
/// </summary>
public class GameReviewVoteModel : IEntityTypeConfiguration<GameReviewVoteModel>
{
    /// <summary>
    /// The Id of the vote.
    /// </summary>
    ...
    /// </summary>
    public GameReviewModel Review { get; set; } = default!;
    #endregion

    public void Configure(EntityTypeBuilder<GameReviewVoteModel> builder)
    {
        builder.ToTable("GameReviewVote");
